...
namespace Kztek.Web.Controllers
{
    public class RoleAdminController : Controller
    {
        ...
        public RoleAdminController(IRoleService _RoleService, IRoleMenuService _RoleMenuService, IMenuFunctionService _MenuFunctionService, IUserRoleService _UserRoleService)
        {
        ...
        public ActionResult Create(Role obj, string menufunctionvalues, bool SaveAndCountinue = false, string group = "")
        {
            ...
            if (result)
            {
                ...
                WriteLog.Write(mes, "FUTECHSUPPORT", obj.Id, obj.RoleName, "Role", name, ActionConfigO.Create);
        ...
        public JsonResult CreateRole(Role obj, string lstId)
        {
            ...
            if (isSuccess)
            {
                ...
                WriteLog.Write(report, "FUTECHSUPPORT", obj.Id, obj.RoleName, "Role", "CreateRole", ActionConfigO.Update);
        ...
        public ActionResult Update(Role obj, string menufunctionvalues, string group = "")
        {
            ...
            if (result)
            {
                ...
                var name = FunctionHelper.getCurrentGroup(group);
                WriteLog.Write(mes, "FUTECHSUPPORT", obj.Id, obj.RoleName, "Role", name, ActionConfigO.Update);
        ...
        public JsonResult Delete(string id)
        {
            ...
            if (isSuccess)
            {
                ...
                WriteLog.Write(report, "FUTECHSUPPORT", obj.Id, obj.RoleName, "Role", name, ActionConfigO.Delete);
