...
namespace Kztek.Web.Areas.Parking.Controllers
{
    public class HomeController : Controller
    {
        ...
        public HomeController(ItblCardGroupService _tblCardGroupService,ItblVehicleGroupService _tblVehicleGroupService,IMenuFunctionService _MenuFunctionService, ItblCardEventService _tblCardEventService, ItblSystemConfigService _tblSystemConfigService)
        {
        ...
        public ActionResult Index(string fromdate, string todate)
        {
            ...
            ViewBag.Vehicles = _tblVehicleGroupService.GetAll();

            var model = _tblCardEventService.CountEventInOut(fromdate, todate);
            var systemconfig = _tblSystemConfigService.GetDefault();
            ViewBag.IsLote = systemconfig != null ? (systemconfig.FeeName.Contains("LOTTE_LIEUGIAI_HN") ? true : false) : false;
            ViewBag.CountInOutCar = _tblCardEventService.CountEventEveryDayCar(fromdate, todate);
           ViewBag.CountEventEveryDay = _tblCardEventService.CountEventEveryDay(fromdate, todate);
            ViewBag.objCardGr = _tblCardGroupService.GetAllActive();
        ...
        #region License
        public async Task<JsonResult> GetLicense()
        {
        ...
        public ActionResult Return()
        {
            ...
            {
                ViewBag.Title = "Thông tin request không hợp lệ!";
                return View();
            }
        ...
        public JsonResult GetPayUrl(string orderid)
        {
            var payUrl = "/Parking/Home";

            var url = MoMoPayment.GetPayUrl_Website(orderid);
