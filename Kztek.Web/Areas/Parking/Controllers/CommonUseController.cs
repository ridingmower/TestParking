...
namespace Kztek.Web.Areas.Parking.Controllers
{
    public class CommonUseController : Controller
    {
        ...
        /// <returns></returns>
        public PartialViewResult DroplistMultiSelectTemplate(DataTable _dt, string itemValue, string itemText, List<string> selectedValues, string Modelname, string lstmoneyid)
        {
