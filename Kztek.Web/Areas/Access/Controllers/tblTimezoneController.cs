...
namespace Kztek.Web.Areas.Access.Controllers
{
    public class tblTimezoneController : Controller
    {
        ...
        public tblTimezoneController(ItblUpdateActionsService _tblUpdateActionsService,ItblAccessTimezoneService _tblAccessTimezoneService)
        {
        ...
        public ActionResult Create(tblAccessTimezoneSubmit obj, bool SaveAndCountinue = false)
        {
            ...
            if (result.isSuccess)
            {
                ...
                else
                {
                    ...
                    objAction.IsUpdateTimeZone = true;
