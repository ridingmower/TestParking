...
namespace Kztek.Web.Areas.Access.Controllers
{
    public class HomeController : Controller
    {
        ...
        public HomeController(IMenuFunctionService _MenuFunctionService, ItblCardEventService _tblCardEventService)
        {
        ...
        {
            var model = _tblCardEventService.CountHOME(fromdate, todate);

            ViewBag.fromdateValue = fromdate;
            ViewBag.todateValue = !string.IsNullOrWhiteSpace(todate) ? Convert.ToDateTime(fromdate).ToString("dd/MM/yyyy 00:00") : DateTime.Now.ToString("dd/MM/yyyy 23:59");
            return View(model);
        }
