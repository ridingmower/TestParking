...
namespace Kztek.Web.Areas.Access.Controllers
{
    public class tblLineController : Controller
    {
        ...
        public tblLineController(ItblUpdateActionsService _tblUpdateActionsService,ItblAccessLineService _tblAccessLineService, ItblAccessPCService _tblAccessPCService)
        {
