...
namespace Kztek.Web.Areas.Access.Controllers
{
    public class tblControllerController : Controller
    {
        ...
        public tblControllerController(ItblUpdateActionsService _tblUpdateActionsService,ItblAccessControllerService _tblAccessControllerService, ItblAccessLineService _tblAccessLineService, ItblAccessControllerGroupService _tblAccessControllerGroupService, ItblAccessDoorService _tblAccessDoorService)
        {
        ...
        public ActionResult Create(tblAccessController obj, bool SaveAndCountinue = false)
        {
            ...
            if (result.isSuccess)
            {
                ...
                else
                {
                    ...
                    objAction.IsUpdateController = true;
