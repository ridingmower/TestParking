...
namespace Kztek.Web.Areas.Locker.Controllers
{
    public class HomeController : Controller
    {
        ...
        private const string groupId = ConstField.LockerID;

        [CheckSessionLogin]
        public ActionResult Index()
        {
            var model = new LockerHome();
            model.ListController = _tblLockerControllerService.GetAllActive();
            model.ListLocker = _tblLockerService.GetAll();
            return View(model);
        }
