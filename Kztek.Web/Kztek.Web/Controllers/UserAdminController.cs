...
namespace Kztek.Web.Controllers
{
    public class UserAdminController : Controller
    {
        ...
        public UserAdminController(IUserService _UserService, IMenuFunctionService _MenuFunctionService, IUserRoleService _UserRoleService, IRoleService _RoleService, ItblSystemConfigService _tblSystemConfigService, IUser_AuthGroupService _User_AuthGroupService, ItblCardGroupService _tblCardGroupService)
        {
        ...
        public ActionResult Index(string key, int? page, string group = "")
        {
            ...
            ViewBag.selectedUserValue = GetSession();
        ...
        public ActionResult Create(User obj, string repass, string rolevalues,string authcardgroupid, HttpPostedFileBase FileUpload, bool SaveAndCountinue = false, string group = "")
        {
            ...
            if (result.isSuccess)
            {
                ...
                WriteLog.Write(result, "FUTECHSUPPORT", obj.Id, obj.Username, "User", name, ActionConfigO.Create);
        ...
        public ActionResult Update(User obj, string pass, string repass, string rolevalues, string authcardgroupid, HttpPostedFileBase FileUpload, int pageNumber = 1, string group = "")
        {
            ...
            if (result.isSuccess)
            {
                ...
                WriteLog.Write(result, "FUTECHSUPPORT", obj.Id, obj.Username, "User", name, ActionConfigO.Update);
        ...
        public JsonResult Delete(string id)
        {
            ...
            if (result.isSuccess)
            {
                ...
                WriteLog.Write(result, "FUTECHSUPPORT", obj.Id, obj.Username, "User", name, ActionConfigO.Delete);
            }
        ...
        public JsonResult RestorePassToDefault(string id)
        {
            ...
            {
                var name = FunctionHelper.getCurrentGroup(GroupID);
                WriteLog.Write(result, "FUTECHSUPPORT", obj.Id, obj.Username, "User", name, ActionConfigO.Restore);
            }
        ...
        {
            var host = Request.Url.Host;
            Session[string.Format("{0}_{1}", SessionConfig.UserAdminChoiceActionParkingSession, host)] = new List<string>();
        ...
        private List<string> GetSetFromSession(List<string> list)
        {
            ...
            var listUserChoice = (List<string>)Session[string.Format("{0}_{1}", SessionConfig.UserAdminChoiceActionParkingSession, host)];
            if (listUserChoice != null)
            {
                //if (list != null)
                //{
            ...
            Session[string.Format("{0}_{1}", SessionConfig.UserAdminChoiceActionParkingSession, host)] = listUserChoice;
